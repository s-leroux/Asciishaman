...
class DocumentBuilder extends CompoundBuilder {
  ...
  close() {
    const document = this.document = new dom.Document();
    document.children = this.children;
...
class SectionBuilder extends CompoundBuilder {
  ...
  close() {
    const node = new dom.Section(this.level, new dom.Text(this.heading));
...
class UnorderedListBuilder extends Builder {
  ...
  close() {
    const node = new dom.UnorderedList(this.level);
    node.children = this.children;
...
class UnorderedListItemBuilder extends CompoundBuilder {
  ...
  close() {
    const node = new dom.UnorderedListItem();
    node.children = this.children;
